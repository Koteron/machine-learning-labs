...
with open('glass.csv', newline='') as csvfile:
    ...
    for row in reader:
        ...
        x_now.append(np.array(row[-1]).astype(np.int64))
...
print(clf.get_depth())
titles = ("Id","RI","Na","Mg","Al","Si","K","Ca","Ba")
classes = ("1", "2", "3", "4", "5", "6", "7")
dot_data = StringIO()
tree.export_graphviz(clf, out_file=dot_data, feature_names=titles, class_names=classes)
